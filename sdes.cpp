...
temp[10]='\0';
//Shift left temp array by 1-bit in left and right part of 5-bit each
...
//Shift left temp array by 2-bit in left and right part of 5-bit each
...
{
// Applying Initial Permutation IP
...
// Applying expansion on right part
...
xors(left,expands);
// Swapping between right part and output of above 
for(int i=0;i<4;i++)
...
cin>>key;
// Declaring storage for key to be generated
char **keys=new char*[2];
keys[0]=new char[9];
keys[1]=new char[9];
// Calling key generation method
